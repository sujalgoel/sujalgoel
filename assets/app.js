...
!(function(e, t) {
	...
	const h = (function(n) {
		...
		function Te(e, t, n, r, i) {
			for (let o, a = [], s = 0, u = e.length, l = t != null; s < u; s++) {
	...
	function fe(e, t) {
		...
		for (let c = 0; c < f; c++) l[c] != null && (e[c].style.display = l[c]);
		return e;
	}
	k.fn.extend({
		show: function() {
	...
	function We(e, t, n) {
		for (let r, i = t ? k.filter(t, e) : e, o = 0; (r = i[o]) != null; o++) {
	...
	k.extend({
		...
		cleanData: function(e) {
			for (
				let t, n, r, i = k.event.special, o = 0;
				void 0 !== (n = e[o]);
				o++
			) {
				if (G(n)) {
	...
	k.each(
		...
		function(e, a) {
			k.fn[e] = function(e) {
				for (let t, n = [], r = k(e), i = r.length - 1, o = 0; o <= i; o++) {
	...
	k.each(
		...
		function(i, o) {
			(k.cssHooks[i + o] = {
				expand: function(e) {
					for (
						let t = 0, n = {}, r = typeof e == 'string' ? e.split(' ') : [e];
						t < 4;
						t++
					) {
