...
function file_video(path) {
   ...
   <video id="dramaplayer" controls data-plyr-config='{ controls: [ 'play-large', 'restart', 'rewind', 'play', 'fast-forward', 'progress', 'current-time', 'duration', 'mute', 'volume', 'captions', 'settings', 'pip', 'download', 'fullscreen'];}'>
   ...
   <track kind="captions" label="English" src="${subtitle}" srclang="en" default>
	...
	// 	container: document.getElementById('dramaplayer'),
	// 	loop: false,
	// 	screenshot: true,
	// 	preload: 'auto',
	// 	subtitle: {
