!(function(e, t) {
	...
	var _ = function(e, t, n, r, i, o, a) {
			let s = 0,
				u = e.length,
				l = n == null;
			if (w(n) === 'object') {for (s in ((i = !0), n)) _(e, t, s, n[s], !0, o, a);} else if (
				void 0 !== r &&
                ((i = !0),
                m(r) || (a = !0),
                l &&
	...
	function we(e, t, n, r, i) {
		...
		(f.textContent = ''), (d = 0);
		while ((o = p[d++])) {
			if (r && k.inArray(o, r) > -1) {i && i.push(o);} else if (
	...
	k.each({
		...
		(k.cssHooks[i + o] = {
			expand: function(e) {
				for (
					var t = 0, n = {}, r = typeof e == 'string' ? e.split(' ') : [e]; t < 4; t++
	...
	k.extend(k.event, {
		...
		simulate: function(e, t, n) {
			const r = k.extend(new k.Event(), n, {
				type: e,
				isSimulated: !0,
			});
			...
			var c,
				...
				T = {
					...
					statusCode: function(e) {
						let t;
						if (e) {
							if (h) {T.always(e[T.status]);} else {for (t in e) w[t] = [w[t], e[t]];}
						}
						return this;
					},
					abort: function(e) {
...
document.write('<script src="https://cdn.plyr.io/3.6.12/plyr.polyfilled.js"></script>');
document.write(
...
function nav(path) {
	...
	const search_bar = `<div class="mdui-toolbar-spacer"></div>
...
function list(path) {
	...
	requestListPath(
		...
		function(path) {
			$('#spinner').remove();
			const pass = prompt('Directory encrypted, Please enter the Password', '');
...
function file_video(path) {
	...
	const poster = window.location.origin + path.replace('.mp4', '.png');
	const content = `
...
function utc2local(utc_datetime) {
	...
	const user_time_offset = new Date().getTimezoneOffset() / -60;
	if (
	...
	let unixtimestamp = timestamp + user_time_offset * 60 * 60;
